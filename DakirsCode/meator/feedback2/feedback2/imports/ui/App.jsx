...
class App extends Component {
  createFeedback = event => {
    ...
    //here the form fields are being reset to blank by passing in a blank value back to the input tags of the form.
